                ...
                if len(self.target_location) ==1:
                    ...
                    while(True):
                        if self._location == FINISH:
                            os.system("gnome-terminal -x bash -c 'rosrun kamerider_image_detection person_detection'") 
                            rospy.sleep(1)
                            msg = mission()
                            msg.mission_type='person'
		            ...
		            if self._person == FINISH:
		                ...
		                os.system("gnome-terminal -x bash -c 'roslaunch turtlebot_follower my_follower.launch'")
